...
async function handleSubmint(values: any) {
  try {
    setLoading(true);
    setApiError(null);
            ...
            <View style={styles.Inputcontainer}>
              ...
              {(formik.touched.email && formik.errors.email) || apiError ? (
                <Text style={{ color: "red", marginBottom: 8 }}>
                  {formik.errors.email ? formik.errors.email : apiError}
                </Text>
              ) : null}
              ...
              <GradientButton
                ...
                style={{
                  ...styles.btn,
                  opacity: formik.values.email && !loading ? 1 : 0.6,
                }}
